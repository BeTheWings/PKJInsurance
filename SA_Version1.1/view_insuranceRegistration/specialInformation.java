...
public class specialInformation extends JFrame {
	...
	public void run() {
		this.info = this.cSpecialInsurance.insertInfo();

		if (this.info.size() != 0) {

			this.info1 = this.info.get(0);
			this.info2 = this.info.get(1);
			this.info3 = this.info.get(2);
			this.info4 = this.info.get(3);
			this.info5 = this.info.get(4);
			this.info6 = this.info.get(5);
