...
import control_accidentReception.cAccidentReceptionApplication;
...
public class accidentReceptionApplicationView extends JFrame {
	...
	public void run() {
		if (painted == true) {
			...
			panel00_0.add(inputText[0]);
			panel00_0.setBackground(Color.white);
			inputText[0].setToolTipText("ex)화재보험1");
			...
			inputText[2].setToolTipText("ex)990101-1020310");
			...
			inputText[3].setToolTipText("ex)010-1234-1234");
			...
			inputText[4].setToolTipText("ex)email@naver.com");
	...
	private void putText() {
		...
		this.list.add(this.inputText[0].getText()); //이름
		this.list.add(this.inputText[1].getText()); //민증
		this.list.add(this.inputText[2].getText());	//폰번호
		this.list.add(this.inputText[3].getText());	//이메일
		this.list.add(this.inputText[4].getText()); //보험이름
		this.list.add(group.getSelection().getActionCommand()); //성별
		this.list.add(this.textArea.getText()); //사고내용
		
		cAccidentReceptionApplication.runAccidentReceptionApplication(list);
	...
	public boolean isBlank() {
		...
		String idNumber = this.inputText[2].getText();
		String phoneNumber = this.inputText[3].getText();
		String eMail = this.inputText[4].getText();
