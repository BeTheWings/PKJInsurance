...
import control_insuranceTool.cInsuranceApproval;
import control_insuranceTool.cinquryAboutInsuranceWaitList;
...
public class insuranceApprovalView extends JFrame {
	...
	private cInsuranceApproval cInsurnaceApproval;
	...
	public insuranceApprovalView() {
		...
		this.cInsurnaceApproval = new cInsuranceApproval();
	...
	public void sendMessage(String message) {
		...
		if (message == "승인") {
			...
			System.out.println(insuranceInform);
