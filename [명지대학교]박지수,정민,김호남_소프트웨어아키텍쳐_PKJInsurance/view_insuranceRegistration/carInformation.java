...
import control_insurance.cCarInsurance;
import model_insurance.mCarInsurance;

public class carInformation extends JFrame {
   ...
   private cCarInsurance cCarInsurance;
   ...
   private JTextArea carAgree1;
   private JTextArea carAgree2;
   private JTextArea carAgree3;
   ...
   public carInformation() {
      ...
      this.carInsuranceRegistrationView = new carInsuranceRegistrationView();
      this.cCarInsurance = new cCarInsurance();
   ...
   public void run() {
      this.carInsurance = this.cCarInsurance.insertInfo();

      if (this.carInsurance.getArraySize()) {
         this.info1 = this.carInsurance.getSubscriptionTarget();
         this.info2 = this.carInsurance.getInsurancePeriod();
         this.info3 = Integer.toString(this.carInsurance.getInsuranceMoney());
         this.info4 = Integer.toString(this.carInsurance.getInsuranceMoney());
         this.info5 = Integer.toString(this.carInsurance.getInsuranceMoney());
         this.info6 = this.carInsurance.getSubscriptionTarget();
         this.state = true;
      } else {
         JOptionPane.showMessageDialog(null, "가입 가능한 자동차보험이 없습니다.");
         this.state = false;
      }

      if (painted == true) {

         this.setTitle("자동차보험 정보안내");
         ...
         JLabel titleLabel = new JLabel("<자동차보험 정보안내>");
         ...
         String context = "1. 자동차보험 주요 내용 계약서";
         ...
         this.carAgree1 = new JTextArea(context2, 5, 20);
         this.carAgree1.setEditable(false);
         this.jScrollPane = new JScrollPane(carAgree1, jScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
         ...
         String sInfor4 = "● 보험" + "\n\r"
               + "- 이 보험은 자동차보험으로써 자동차를 탑승한 상태에서 다른 차량과 보행자, 혹은 보행 중 다른 차량과의 접촉사고가 발생했을시 보상해주는 보험입니다." + "\n\r"
               ...
               + "\n\r" + "- 자동차 사고로 인한 손실이 발생했을 경우 보험금은 최대 " + info5 + "원 입니다." + "\n\r" + "● 보험금 지급 안내" + "\n\r"
         ...
         this.carAgree2 = new JTextArea(sInfor4, 5, 10);
         this.carAgree2.setEditable(false);
         this.jScrollPane2 = new JScrollPane(carAgree2, jScrollPane2.VERTICAL_SCROLLBAR_ALWAYS,
         ...
         this.carAgree3 = new JTextArea(info6, 5, 10);
         this.carAgree3.setEditable(false);
         this.jScrollPane3 = new JScrollPane(carAgree3, jScrollPane2.VERTICAL_SCROLLBAR_ALWAYS,
               jScrollPane2.HORIZONTAL_SCROLLBAR_AS_NEEDED);
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         if (e.getActionCommand() == "다음") {
            ...
            if (answer1 != "동의1" || answer2 != "동의2") {
               ...
               carInsuranceRegistrationView.getInformation(name, date, inputTextSize);
