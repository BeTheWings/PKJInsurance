...
import control_insuranceDesigning.cOnTheSeaInsuranceDesinging;
...
public class onTheSeaInsuranceDesigningView extends JFrame {
	...
	public void run() {
		if (painted == true) {
			...
			inputText[1].setToolTipText("ex)바다에서 일을 하는 20세 이상 남녀");
			...
			inputText[2].setToolTipText("ex)10000");
			...
			inputText[6].setToolTipText("ex)최근 3년 내 해상사고가 없는 사람");
	...
	public boolean isBlank() {
		...
		if (insuranceName.equals("")) {
			...
			checker = cOnTheSeaInsuranceDesinging.checkOverlap(insuranceName); // 보험이름중복
			if (checker) {
	...
	private void putText() {
		...
		this.cOnTheSeaInsuranceDesinging.setData(this.data);
	}
