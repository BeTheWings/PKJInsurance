...
public class cOnTheSeaInsuranceDesinging {
	...
	public void setData(ArrayList<String> data) {
		...
		this.mInsuranceDesinging.setInsuranceCategory("해상보험");

		this.mInsuranceDesinging.onTheSeaInsert(this.mInsuranceDesinging);
	}

	public boolean checkOverlap(String insuranceName) {
		boolean checker = false;
		checker = this.mInsuranceDesinging.checkOverlap(insuranceName);
		return checker;
	}
