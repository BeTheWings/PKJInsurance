...
import control_insuranceDesigning.cFireInsuranceDesigning;
...
public class fireInsuranceDesigningView extends JFrame {
	...
	public void run() {
		...
		if (painted == true) {
			...
			inputText[1].setToolTipText("ex)집이나 건물, 땅을 소유하고 있는 남녀노소");
			...
			inputText[5].setToolTipText("ex)10000000");
	...
	private void putText() {
		...
		this.cFireInsuranceDesigning.setData(this.data);
	}
	...
	public boolean isBlank() {
		...
		if (insuranceName.equals("")) {
			...
			checker = cFireInsuranceDesigning.checkOverlap(insuranceName); // 보험이름중복
			if (checker) {
