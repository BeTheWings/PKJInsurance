...
public class specialInsuranceRegistrationView extends JFrame {
   ...
   public void run() {
      if (painted == true) {
         ...
         inputLabel = new JLabel("                                                  11. 소유재산을 입력해주세요");
         ...
         inputText[6].setToolTipText("ex)야외이벤트를 진행하려 하였으나 갑작스런 폭우로 진행불가능. 손해비 500000원");
   ...
   public void putText() {
      ...
      cSpecialInsuranceRegistration.setAge(inputText[2].getText());
      ...
      cSpecialInsuranceRegistration.setAccidentHistory(inputText[6].getText());
      cSpecialInsuranceRegistration.setEmail(inputText[7].getText());
      cSpecialInsuranceRegistration.setProperty(inputText[8].getText());
      ...
      cSpecialInsuranceRegistration.setLongterm(group3.getSelection().getActionCommand());
      cSpecialInsuranceRegistration.setSpecialType(group4.getSelection().getActionCommand());
      cSpecialInsuranceRegistration.setSelectAccidentHistory(group5.getSelection().getActionCommand());
      cSpecialInsuranceRegistration.setTotalPrice(this.totalPrice);
      cSpecialInsuranceRegistration.setDate(this.date);
   ...
   public boolean isBlank(ActionEvent e) {
      ...
      String accidentHistory = this.inputText[6].getText();
