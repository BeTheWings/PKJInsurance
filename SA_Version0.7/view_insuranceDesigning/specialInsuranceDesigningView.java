...
public class specialInsuranceDesigningView extends JFrame {
	...
	public void run() {
		if (painted == true) {
			...
			inputText[0].setToolTipText("ex)남녀노소");
			...
			inputText[1].setToolTipText("ex)7000");
			...
			inputText[4].setToolTipText("ex)3000000");
	...
	private void putText() {
		...
		cSpecialInsurnaceDesigning.setLongtermPeriod(check1);
