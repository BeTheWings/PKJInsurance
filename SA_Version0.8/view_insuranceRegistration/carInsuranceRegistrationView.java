...
public class carInsuranceRegistrationView extends JFrame {
   ...
   public void putText() {
      ...
      cCarInsuranceRegistration.setAge(inputText[2].getText());
      ...
      cCarInsuranceRegistration.setEmail(inputText[6].getText());
      cCarInsuranceRegistration.setCarNumber(inputText[7].getText());
      cCarInsuranceRegistration.setAccidentHistory(inputText[8].getText());
      ...
      cCarInsuranceRegistration.setCarModel(group3.getSelection().getActionCommand());
      cCarInsuranceRegistration.setLongterm(group4.getSelection().getActionCommand());
      cCarInsuranceRegistration.setSelectAccidentHistory(group5.getSelection().getActionCommand());
      cCarInsuranceRegistration.setTotalPrice(this.totalPrice);
      cCarInsuranceRegistration.setDate(this.date);
