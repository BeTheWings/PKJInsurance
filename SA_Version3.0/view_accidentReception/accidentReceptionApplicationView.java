...
public class accidentReceptionApplicationView extends JFrame {
	...
	private void putText() {
		cAccidentReceptionApplication.setInsuranceName(this.inputText[4].getText());
		...
		cAccidentReceptionApplication.setGedner(group.getSelection().getActionCommand());
		cAccidentReceptionApplication.setAccidnetContent(this.textArea.getText());
