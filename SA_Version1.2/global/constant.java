...
public class constant {
	...
	public static enum retrievalInfo {
		name("보험이름"), category("보험종류"),payOut("보험금"), payIn("보험비"), period("보험기간");
	...
	public static enum clientTable {
		insurance("보험"), name("고객 이름"), id("나이"), eMail("메일"), history("이력");
	...
	public static enum accidentTable {
		name("고객 이름"), id("주민번호"), content("사고내용"), insuranceContent("사고내용");
