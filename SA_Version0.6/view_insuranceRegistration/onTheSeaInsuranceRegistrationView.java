...
public class onTheSeaInsuranceRegistrationView extends JFrame {
   ...
   public void run() {
      if (painted == true) {
         ...
         inputText[6].setToolTipText("ex)동해바다에서 어업을 하다 바다에 빠지는 사고 발생. 병원비 150000원");
   ...
   public void putText() {
      ...
      cOnTheSeaInsuranceRegistration.setAge(inputText[2].getText());
      ...
      cOnTheSeaInsuranceRegistration.setAccidentHistory(inputText[6].getText());
      cOnTheSeaInsuranceRegistration.setEmail(inputText[7].getText());
      ...
      cOnTheSeaInsuranceRegistration.setSelectAccidentHistory(group6.getSelection().getActionCommand());
      cOnTheSeaInsuranceRegistration.setTotalPrice(this.totalPrice);
      cOnTheSeaInsuranceRegistration.setDate(this.date);
   ...
   public boolean isBlank() {
      ...
      if (inputText[6].isEditable() != false) {
         accidentHistory = inputText[6].getText();
      } else {
