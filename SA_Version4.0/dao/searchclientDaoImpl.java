...
public class searchclientDaoImpl extends dao implements searchDao {
	...
	public ArrayList<String> searchForClientInfor(mClient clientVO) {
		this.test = new ArrayList<String>();
		SqlSession session = super.getSqlSession();

		List<mClient> output = session.selectList("InsuranceToolClientMapper.searchForClientInfor", clientVO);
