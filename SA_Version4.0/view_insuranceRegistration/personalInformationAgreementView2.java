...
public class personalInformationAgreementView2 extends JFrame {
	...
	public void run() {
		...
		if (painted == true) {
			...
			this.personalInformationAgreement.setEditable(false);
			...
			this.personalInformationAgreement2.setEditable(false);
	...
	public boolean isBlank() {
		date = this.inputText[0].getText();
		name = this.inputText[1].getText();

		if (date.equals("")) {
			JOptionPane.showMessageDialog(null, "작성일자를 입력해주세요!");
		} else if (name.equals("")) {
	...
	class actionHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getActionCommand() == "다음") {
				...
				answer3 = "동의3";
			} else if (e.getActionCommand() == "동의X1") {
				answer1 = null;
			} else if (e.getActionCommand() == "동의X2") {
				answer2 = null;
			} else if (e.getActionCommand() == "동의X3") {
				answer3 = null;
			}
		}
	}
