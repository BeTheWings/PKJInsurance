...
public class fireInsuranceRegistrationView extends JFrame {
	...
	public void putText() {
		...
		if (inputText[6].isEditable() != false) {
			Data.add(inputText[6].getText());
		} else {
			Data.add(this.property);

		}
		if (inputText[7].isEditable() != false) {
			Data.add(inputText[7].getText());

		} else {
			Data.add(this.selectAccidentHistory);
		}
		Data.add(group1.getSelection().getActionCommand());
		Data.add(group2.getSelection().getActionCommand());
		Data.add(group4.getSelection().getActionCommand());
		Data.add(group5.getSelection().getActionCommand());
		Data.add(Integer.toString(this.totalPrice));
		Data.add(this.date);
	
		cFireInsuranceRegistration.run(Data);
	}
