...
public class cSpecialInsurance {
   ...
   private insurance.specialInsuranceVO specialInsurance;
   private specialInsuranceDaoImpl specialInsuranceDaoImpl;

   public cSpecialInsurance() {
      this.info = new ArrayList<String>();
      this.specialInsurance = new insurance.specialInsuranceVO();
      try {
   ...
   public insurance.specialInsuranceVO insertInfo() {
