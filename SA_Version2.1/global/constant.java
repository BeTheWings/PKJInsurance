...
public class constant {
	...
	public static enum retrievalclientInfo {
		insuranceCategory("보험 카테고리"), name("이름"), insuranceName("가입된 보험"), residentRegistrationNumber("주민등록번호"),
		gender("성별");
	...
	public static enum retrievalInfo {
		category("보험 카테고리"), name("보험이름"), payIn("납입금"), insuranceMoney("보험금"), period("보험기간");
	...
	public static enum clientTable {
		insurance("보험"), name("고객 이름"), id("나이"), phnoe("전화번호"), history("이력");
	...
	public static enum accidentTable {
		category("보험 카테고리"), name("보험이름"), clientName("이름"), phone("전화번호"), accident("사고내용");
