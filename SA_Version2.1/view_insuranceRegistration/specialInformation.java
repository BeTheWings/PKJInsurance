...
import insurance.specialInsuranceVO;
...
public class specialInformation extends JFrame {
   ...
   private specialInsuranceVO specialInsurance;
   ...
   public specialInformation() {
      ...
      this.specialInsurance = new specialInsuranceVO();
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         if (e.getActionCommand() == "다음") {
            ...
            if (answer1 != "동의1" || answer2 != "동의2") {
               ...
               specialInsuranceRegistrationView.getInformation(name, date, totalPrice);
